        ...
        <div class="inner-form">
         ...
         <br>
          <div class="advance-search">
            ...
            <%
		Vector<User> users = (Vector<User>) request.getSession().getAttribute("Users");
	...
	%>
			...
			<tr width = "100%">
				<td class = "image" width = "40%">
					<a href="SearchServlet?val=<%=i %>" >
						<img id = "image<%=i%>" src="img/<%=Integer.toString(users.get(i).photoID) + ".jpg"%>" width="70" height="70">
					</a>
					
					
				</td>
				<td class = "userInfo" width = "60%">
					<p class = "title"><%=users.get(i).username %></p>
					<p class = "author">Interests: 
				<%
					Vector<String> authors = users.get(i).interest;
